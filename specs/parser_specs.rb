...
describe "An RDFObject Parser" do
  ...
  it "should have created resources from an rdf/xml I/O and set their values properly" do
    ...
    r1["http://www.w3.org/2000/01/rdf-schema#label"].first.language.should ==(:zh)
  ...
  it "should have created resources from a JSON I/O and set their values properly" do 
    ...
    r1["http:\/\/www.w3.org\/2004\/02\/skos\/core#prefLabel"].should be_kind_of(RDF::Literal)
    r1["http:\/\/www.w3.org\/2004\/02\/skos\/core#prefLabel"].language.should ==(:en)    
  end
  ...
  it "should correctly find and build nested resources in an RSS 1.0 document" do
    ...
    resources.should be_kind_of(Collection)
    r1 = resources["http://lcsubjects.org/subjects/sh85068937#concept"]
    r1["http://www.w3.org/2004/02/skos/core#prefLabel"].value.should == ("Italy--History--To 476")
    r1["http://www.w3.org/2004/02/skos/core#prefLabel"].language.should == (:en)    
    ...
    r2["http://www.w3.org/2004/02/skos/core#prefLabel"].value.should == ("Veneti (Italic people)")
  ...
  it "should identify and parse blank nodes from RDF/XML" do
    collection = Parser.parse(open(File.dirname(__FILE__) + '/files/bnodes.rdf'))
    i = 0
